...
class CircuitBreakerBasedOnCountsTest {
    ...
    @DisplayName("sliding window size 만큼 메서드 호출하지 않았다면 circuit은 close 상태이다.")
    @Test
    void closedCircuitEvenIfAlreadyExceedsFailureThresholdWithoutSatisfyingSlidingWindowSize() {
        // given
